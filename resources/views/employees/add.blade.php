...
<div class="container">
  ...
  <form method="POST" id="addEmployee" name="addEmployee" action="{{ url('save-employee') }}" enctype="multipart/form-data">
    {{csrf_field()}}
    ...
    <div class="form-group">
      <label for="datepicker">Date of Birth</label>
        <input type="text" id="datepicker" class="form-control" name="dob" value="{{ old('dob') }}"></p>
    </div>
